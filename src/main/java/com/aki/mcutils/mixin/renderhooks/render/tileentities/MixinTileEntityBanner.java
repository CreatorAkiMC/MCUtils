...
@Mixin(value = TileEntityBanner.class, priority = MCUtils.ModPriority)
public class MixinTileEntityBanner extends TileEntity {
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        ...
        if (block instanceof BlockBanner.BlockBannerHanging) {
            y0--;
        } else if (block instanceof BlockBanner.BlockBannerStanding) {
            y1++;
        }
