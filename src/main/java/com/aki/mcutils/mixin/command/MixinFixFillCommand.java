...
public class MixinFixFillCommand extends CommandBase {
    public int MaxBlockSets = Integer.MAX_VALUE;
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            if (i > MaxBlockSets)
            {
                throw new CommandException("commands.fill.tooManyBlocks", new Object[] {i, Integer.valueOf(MaxBlockSets)});
            }
