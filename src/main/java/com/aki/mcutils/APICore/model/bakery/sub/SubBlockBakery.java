...
import com.aki.mcutils.APICore.model.bakery.generation.IBlockBakery;
import com.aki.mcutils.APICore.model.bakery.generation.ILayeredBlockBakery;
...
public class SubBlockBakery implements ILayeredBlockBakery, TextureUtils.IIconRegister {
    ...
    public void registerIcons(TextureMap textureMap) {
        for (IBlockBakery bakery : subBakeries.values()) {
            if (bakery instanceof TextureUtils.IIconRegister) {
                ((TextureUtils.IIconRegister) bakery).registerIcons(textureMap);
            }
        }
    }
}
