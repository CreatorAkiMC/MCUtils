...
import com.aki.mcutils.APICore.program.ccr.render.particle.IModelParticleProvider;
...
public abstract class AbstractBakedPropertiesModel implements IModelParticleProvider, IBakedModel {
    ...
    public Pair<? extends IBakedModel, Matrix4f> handlePerspective(TransformType cameraTransformType) {
        if (properties instanceof ModelProperties.PerspectiveProperties) {
            return PerspectiveMapWrapper.handlePerspective(this, ((ModelProperties.PerspectiveProperties) properties).getModelState(), cameraTransformType);
        }
