...
public class PerspectiveAwareLayeredModel extends AbstractPerspectiveLayeredModel {
    ...
    public PerspectiveAwareLayeredModel(Map<BlockRenderLayer, Map<EnumFacing, List<BakedQuad>>> layerFaceQuadMap, ModelProperties.PerspectiveProperties properties) {
        this(layerFaceQuadMap, ImmutableMap.of(), properties, BlockRenderLayer.SOLID);
    }

    public PerspectiveAwareLayeredModel(Map<BlockRenderLayer, Map<EnumFacing, List<BakedQuad>>> layerFaceQuadMap, Map<BlockRenderLayer, List<BakedQuad>> layerGeneralQuads, ModelProperties.PerspectiveProperties properties, BlockRenderLayer generallayer) {
