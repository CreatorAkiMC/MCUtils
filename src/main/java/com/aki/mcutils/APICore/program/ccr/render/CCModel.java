...
import com.aki.mcutils.APICore.Utils.ArrayUtils;
import com.aki.mcutils.APICore.Utils.Copyable;
import com.aki.mcutils.APICore.Utils.VectorUtils;
import com.aki.mcutils.APICore.Utils.vec.*;
import com.aki.mcutils.APICore.Utils.vec.uv.UV;
import com.aki.mcutils.APICore.Utils.vec.uv.UVTransformation;
import com.aki.mcutils.APICore.Utils.vec.uv.UVTranslation;
import com.aki.mcutils.APICore.lighting.LC;
import com.aki.mcutils.APICore.lighting.LightModel;
import com.aki.mcutils.APICore.program.ccr.render.pipeline.IVertexOperation;
import com.aki.mcutils.APICore.program.ccr.render.pipeline.IVertexSource;
import com.aki.mcutils.APICore.program.ccr.render.pipeline.VertexAttribute;
import com.aki.mcutils.APICore.program.ccr.render.pipeline.attribute.*;

import java.util.*;

import static com.aki.mcutils.APICore.Utils.vec.Rotation.sideRotations;
    ...
    public CCModel expand(int extraVerts) {
        ...
        for (int i = 0; i < attributes.size(); i++) {
            if (attributes.get(i) != null) {
                attributes.set(i, VertexAttribute.copyOf((AttributeKey) AttributeKey.AttributeKeyRegistry.getAttributeKey(i), attributes.get(i), newLen));
            }
        }
