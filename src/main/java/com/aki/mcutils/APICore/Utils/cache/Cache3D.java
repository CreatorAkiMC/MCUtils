...
public class Cache3D<V> {
    ...
    public V computeIfAbsent(BlockPos pos, Function<BlockPos, V> mappingFunction) {
        return computeIfAbsent(pos.getX(), pos.getY(), pos.getZ(), (x, y, z) -> mappingFunction.apply(pos));
    }
    ...
    public V computeIfPresent(BlockPos pos, BiFunction<BlockPos, V, V> mappingFunction) {
        return computeIfPresent(pos.getX(), pos.getY(), pos.getZ(), (x, y, z, t) -> mappingFunction.apply(pos, t));
    }
    ...
    public V compute(BlockPos pos, BiFunction<BlockPos, V, V> mappingFunction) {
        return compute(pos.getX(), pos.getY(), pos.getZ(), (x, y, z, t) -> mappingFunction.apply(pos, t));
    }
