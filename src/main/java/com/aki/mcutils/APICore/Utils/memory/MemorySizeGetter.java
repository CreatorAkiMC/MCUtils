...
public class MemorySizeGetter {
    ...
    public static long deepMemoryUsageOf(Object obj) {
        return deepMemoryUsageOf(obj, MemorySizeGetter.VisibilityFilter.NON_PUBLIC);
    }

    public static long deepMemoryUsageOf(Object obj, MemorySizeGetter.VisibilityFilter referenceFilter) {
    ...
    public static long deepMemoryUsageOfAll(Collection<? extends Object> objs) {
        return deepMemoryUsageOfAll(objs, MemorySizeGetter.VisibilityFilter.NON_PUBLIC);
    }

    public static long deepMemoryUsageOfAll(Collection<? extends Object> objs, MemorySizeGetter.VisibilityFilter referenceFilter) {
    ...
    private static long deepMemoryUsageOf0(Instrumentation instrumentation, Set<Integer> counted, Object obj, MemorySizeGetter.VisibilityFilter filter) throws SecurityException {
    ...
    private static boolean isOf(MemorySizeGetter.VisibilityFilter f, int mod) {
        switch(f.ordinal()) {
            case 1:
                return true;
            case 2:
