...
public class ExplosionHelper {
    ...
    private ExtendedBlockStorage getBlockStorage(BlockPos pos) {
        Chunk chunk = getChunk(pos);
        return chunk.getBlockStorageArray()[pos.getY() >> 4];
    }
    ...
    public void finish() {
        ...
        ProcessHandler.addProcessEvent(process);
    }
    ...
    private static class RemovalProcess implements IProcessMethod {
        ...
        public void ServerUpdateProcess() {
            ...
            while (MinecraftServer.getCurrentTimeMillis() - server.currentTime < 50 && this.helper.toRemove.size() > 0) {
                //LogHelper.dev("Processing chunks at rad: " + index);
                //System.out.print("Processing chunks at rad: " + index + "\n");
